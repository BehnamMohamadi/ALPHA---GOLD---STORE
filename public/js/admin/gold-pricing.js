...
const loadPricing=async()=>{
  try{
    ...
    form.elements.wageType.value=g.wage?.type||"percent";
    form.elements.wageValue.value=g.wage?.value??"";
    form.elements.profitPercent.value=g.profitPercent??"";
    form.elements.taxPercent.value=g.taxPercent??"";
    form.elements.source.value=g.source??"manual";
    document.getElementById("pricingKey").textContent=g.key;
    document.getElementById("pricingSource").textContent=g.source||"—";
